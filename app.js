  ...
  render() {
    ...
    return (
      <div className={class_name} onClick={this.props.onClickTask}>
        ...
        <span><svg onClick={this.props.onClickClose} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="close text-white mr-2 text-center bi bi-x-circle" viewBox="0 0 16 16">
            ...
            <form
              ...
              <div className="input-group input-group-lg mb-3">
                ...
                <div class="input-group-append">
                  <button type="submit" className="btn btn-light"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-plus-lg my-auto" viewBox="0 0 16 16">
