  ...
  render() {
    ...
    return (
      <div className={class_name} onClick={this.props.onClickTask}>
        ...
        <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="close text-white mr-2 text-center bi bi-x-circle" viewBox="0 0 16 16" onClick={this.props.onClickClose}>
